namespace OganiShop.Data.Migrations
{
    ...
    public partial class Finals : DbMigration
    {
        public override void Up()
        {
            CreateStoredProcedure("GetRevenueStatistic",
                ...
                sum(od.Quantity*od.CurrentPrice) as Revenues,
                sum((od.Quantity*od.CurrentPrice)-(od.Quantity*p.OriginalPrice)) as Benefit
                from Orders o
